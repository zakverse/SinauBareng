<div class="bg-white rounded-2xl p-4 mb-8 flex justify-between items-center shadow-sm border border-gray-100">
    <div class="relative w-96">
        ...
        <input type="text" placeholder="Search" class="w-full bg-gray-50 border-none rounded-xl pl-12 pr-4 py-2 focus:ring-2 focus:ring-indigo-400 outline-none">
    </div>
    ...
    <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->username) }}&background=random" class="w-10 h-10 rounded-full">
        </div>
    </div>
</div>